...
BarraDeCombo.prototype = {
    atualizar: function() {
        ...
        if (this.finalizacao == 1 && this.timerfinal <= 0){
            this.finalizacao = 0;
            this.combofinal = 0;
            this.gradefinal = 0;
            this.combo = 0;
        ...
        else if (this.tempodocombo <= 0 && this.finalizacao == 0){
            this.zerarplacar();
    ...
    desenhar: function() {
        ...
        if (this.finalizacao == 1){
            context.fillStyle = this.cordocombo;
            context.fillText(`Combo: ${Math.trunc(this.combofinalizado)}`, 50, 50);
            context.strokeStyle = this.cordaborda;
            context.lineWidth = 1;
            context.strokeText(`Combo: ${Math.trunc(this.combofinalizado)}`, 50, 50);
        }
        else {
            context.fillStyle = this.cordocombo;
    ...
    zerarplacar: function(){
        this.combofinalizado = this.combo;
        this.gradefinal = this.grade;
        this.tempodocombo = 0;
        this.combo = 0;
        context.strokeStyle = this.cordaborda;
        this.placarfinal();
    },
    placarfinal: function(){
        this.finalizacao = 1;
        this.timerfinal = 1000;   
    }
}